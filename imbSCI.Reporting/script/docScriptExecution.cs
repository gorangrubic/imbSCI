            ...
            switch (ins.type)
            {
                case appendType.s_settings:
                        ...
                        if (ins.containsKey(d.dsa_background))
                        {
                            ...
                            string bgColor = ins.getProperString(Color.White.toHexColor(), d.dsa_background);
                            string fgColor = ins.getProperString(Color.Black.toHexColor(), d.dsa_forecolor);
                        ...
                        else if (ins.containsKey(d.dsa_variationRole))
                        {
                            ...
                            docRender.ApplyColor(col.toHexColor());
                            render.c.enter();
                        }
