...
namespace imbSCI.Reporting.meta.page
{
    ...
    public class metaPalettePage:metaPage
    {
        ...
        public override docScript compose(docScript script)
        {
            ...
            Color altColor = hexColor.getColorFromHex();
        ...
        public docScript composeForPalette(docScript script, Color baseColor, float bright, float sat, int hue, string title, bool doLabels=false)
        {
            ...
            aceColorPalette pal = new aceColorPalette(altOne.toHexColor());
            ...
            for (int i = 0; i < pal.ccount; i++)
            {
                ...
                {
                    script.AppendLine(appendType.bold, pal.bgColors[i].toHexColor());
            ...
            for (int i = 0; i < pal.ccount; i++)
            {
                ...
                {
                    script.AppendLine(appendType.bold, pal.tpColors[i].toHexColor());
            ...
            for (int i = 0; i < pal.ccount; i++)
            {
                ...
                {
                    script.AppendLine(appendType.bold, pal.fgColors[i].toHexColor());
        ...
        public metaPalettePage(string hexBaseColor)
        {
            ...
            settings.tabHeadColor = hexBaseColor.getColorFromHex();
