// --------------------------------------------------------------------------------------------------------------------
// <copyright file="pagePresetTestItemIndex.cs" company="imbVeles" >
//
...
namespace imbSCI.Reporting.meta.presets.servicepages
{
    ...
    public class pagePresetTestItemIndex:metaServicePage
    {
        public pagePresetTestItemIndex()
        {
          //   outputs = exporters.metaExporterOutput.markdown | exporters.metaExporterOutput.markdownHtml;
