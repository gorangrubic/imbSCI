// --------------------------------------------------------------------------------------------------------------------
// <copyright file="pagePresetTestItemReadme.cs" company="imbVeles" >
//
...
namespace imbSCI.Reporting.meta.presets.servicepages
{
    ...
    public class pagePresetTestItemReadme: pagePresetGeneralReadme
    {
        public pagePresetTestItemReadme()
        {
