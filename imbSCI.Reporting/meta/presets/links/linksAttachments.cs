// --------------------------------------------------------------------------------------------------------------------
// <copyright file="linksAttachments.cs" company="imbVeles" >
//
...
namespace imbSCI.Reporting.meta.presets.links
{
    ...
    public class linksAttachments:metaLinkCollection
    {
        public linksAttachments()
        {
            type = metaLinkCollectionType.relative;
            rootRelativePath = "\\_attachments";
