// --------------------------------------------------------------------------------------------------------------------
// <copyright file="deliveryUnitBootmarkReport.cs" company="imbVeles" >
//
...
namespace imbSCI.Reporting.meta.delivery.units
{
    ...
    public class deliveryUnitBootmarkReport : deliveryUnit
    {
        public deliveryUnitBootmarkReport() : base("Bootmark imbVeles deliveryInstance unit")
        {
        ...
        public override void setup()
        {
            ...
            var footer_delivery = AddItem(new deliveryUnitItemFileOutput("veles_report\\footer.md", templateFieldSubcontent.html_footer, deliveryUnitItemLocationBase.localResource, "Page footer", "Include at end of page"));
            ...
            var renderOutputTemplate = new deliveryUnitItemContentTemplated("velestrap\\index.html", renderOutput, reportOutputFormatName.textHtml,renderDirectory.levels );
            ...
            AddReportIncludeFiles("testdocs", renderOutputTemplate, "*.md", false);
