...
namespace imbSCI.Graph.MXGraph.utils
{
    ...
    public class mxUtils
    {
        ...
        public static mxRectangle GetSizeForString(String text, Font font, int width)
        {
            ...
            var width_d =  font.Size * text.Length* width;
         ...
         //   Size result = TextRenderer.MeasureText(text, font, proposedSize, flags);
            ...
            return new mxRectangle(0, 0, width_d, width_d*0.6);
        }
        ...
        public static void FillClippedRect(System.Drawing.Graphics g, Brush brush, int x, int y, int width, int height)
        {
