// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DotAttributeAttribute.cs" company="imbVeles" >
//
...
namespace imbSCI.Graph.DOT
{
    ...
    public class GraphAttributeAttribute : Attribute
    {
        public string name { get; }

        public object DefaultValue { get; }

        public GraphAttributeAttribute(string name, object defaultValue)
        {
            this.name = name;
