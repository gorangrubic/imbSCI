...
using com.mxgraph.layout.hierarchical.stage.mxCoordinateAssignment;
using com.mxgraph.layout.hierarchical.stage.mxHierarchicalLayoutStage;
using com.mxgraph.layout.hierarchical.stage.mxMedianHybridCrossingReduction;
using com.mxgraph.layout.hierarchical.stage.mxMinimumCycleRemover;
using com.mxgraph.model.mxGraphModel;
...
JGraphLayout.Stoppable*/
{
	 ...
	 */
	protected Int32 parentBorder = 0;
	 ...
	 * 
	 */
	public mxHierarchicalLayout(mxGraph graph, Int32 orientation)
	{
		super(graph);
