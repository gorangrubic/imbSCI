		...
		mxHierarchicalLayoutStage/*, JGraphLayout.Stoppable*/
{
	 ...
	 * crossings
	 */
	protected Int32 maxIterations = 24;
	 ...
	 */
	protected Int32 currentBestCrossings = 0;

	protected Int32 iterationsWithoutImprovement = 0;

	protected Int32 maxNoImprovementIterations = 2;
	 ...
	 */
	private Int32 calculateCrossings(mxGraphHierarchyModel model)
	{
	 ...
	 */
	protected Int32 calculateRankCrossing(int i, mxGraphHierarchyModel model)
	{
		int totalCrossings = 0;
		mxGraphHierarchyRank rank = model.ranks.get(new Integer(i));
