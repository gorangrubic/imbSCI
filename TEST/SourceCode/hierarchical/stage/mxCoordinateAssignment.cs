...
using com.mxgraph.layout.hierarchical.mxHierarchicalLayout;
using com.mxgraph.layout.hierarchical.model.mxGraphAbstractHierarchyCell;
using com.mxgraph.layout.hierarchical.model.mxGraphHierarchyEdge;
using com.mxgraph.layout.hierarchical.model.mxGraphHierarchyModel;
using com.mxgraph.layout.hierarchical.model.mxGraphHierarchyNode;
using com.mxgraph.layout.hierarchical.model.mxGraphHierarchyRank;
using com.mxgraph.util.mxPoint;
using com.mxgraph.util.mxRectangle;
using com.mxgraph.util.mxUtils;
...
public class mxCoordinateAssignment implements mxHierarchicalLayoutStage
{
	 ...
	 */
	protected Int32 maxIterations = 8;

	/// <summary>
	 * The preferred horizontal distance between edges exiting a vertex
	 */
	protected Int32 prefHozEdgeSep = 5;

	/// <summary>
	 * The preferred vertical offset between edges exiting a vertex
	 */
	protected Int32 prefVertEdgeOff = 2;

	/// <summary>
	 * The minimum distance for an edge jetty from a vertex
	 */
	protected Int32 minEdgeJetty = 12;

	/// <summary>
	 * The size of the vertical buffer in the center of inter-rank channels
	 * where edge control points should not be placed
	 */
	protected Int32 channelBuffer = 4;
	 ...
	 * laid out graph
	 */
	protected Int32 orientation = SwingConstants.NORTH;
	 ...
	 */
	protected Int32 groupPadding = 10;
	...
	protected void rankMedianPosition(int rankValue,
			mxGraphHierarchyModel model, Int32 nextRankValue)
	{
	 ...
	 */
	private Int32 calculatedWeightedValue(
	 ...
	 */
	private Int32 medianXValue(Object[] connectedCells, Int32 rankValue)
	{
	...
	protected boolean repositionValid(mxGraphHierarchyModel model,
			mxGraphAbstractHierarchyCell cell, Int32 rank, double position)
	{
...
//		}
	...
	protected class WeightedCellSorter implements Comparable<Object>
	{
		 ...
		 *         double
		 */
		public Int32 compareTo(Object arg0)
		{
	 ...
	 */
	protected class AreaSpatialCache : Rectangle2D.Double
	{
