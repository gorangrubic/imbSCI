...
using com.mxgraph.model.mxICell;
...
public class mxStackLayout : mxGraphLayout
{
	 ...
	 * spacing, orientation and offset.
	 */
	public mxStackLayout(mxGraph graph, boolean horizontal, Int32 spacing)
	{
