...
public class mxCompactTreeLayout : mxGraphLayout
{
	 ...
	 */
	protected Int32 levelDistance = 10;

	/**
	 * Holds the nodeDistance. Default is 20.
	 */
	protected Int32 nodeDistance = 20;
	...
	public void execute(Object parent, Object root)
	{
		...
		if (root == null)
		{
			...
			t> roots = findTreeRoots(parent, invert);
	...
	protected class WeightedCellSorter implements Comparable<Object>
	{
		...
		public WeightedCellSorter(TreeNode cell, Int32 weightedValue)
		{
			this.cell = cell;
