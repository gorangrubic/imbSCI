// --------------------------------------------------------------------------------------------------------------------
// <copyright file="aceCollectionLimitSafe.cs" company="imbVeles" >
//
...
namespace imbSCI.Data.collection
{
    ...
    public class aceCollectionLimitSafe<T>:imbBindable, IEnumerable<T>, IList<T>
    {
        ...
        /// <returns></returns>
        protected Int32 resolveKey(Int32 key)
        {
