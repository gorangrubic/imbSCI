...
namespace imbSCI.Core.reporting.colors
{
    ...
    public class acePaletteProvider:Dictionary<acePaletteRole, aceColorPalette>
    {
        ...
        public colorWhellForContent getColorWheel(acePaletteRole role = acePaletteRole.none)
        {
            ...
            colorWhellForContent output = new colorWhellForContent(pal.bgColors[acePaletteVariationRole.even.ToInt32()].toHexColor(), pal.bgColors[acePaletteVariationRole.odd.ToInt32()].toHexColor(), pal.bgColors[acePaletteVariationRole.important.ToInt32()].toHexColor());
            output.header = pal.bgColors[acePaletteVariationRole.header.ToInt32()].toHexColor();
            output.footer = pal.bgColors[acePaletteVariationRole.important.ToInt32()].toHexColor();
            output.heading = pal.bgColors[acePaletteVariationRole.heading.ToInt32()].toHexColor();
            return output;
        }
        ...
        {
            return current.bgColors[role.ToInt32()].toHexColor();
