...
using System.Collections.Generic;
    ...
    /// <summary>
    /// Delegate used by <see cref="dataTableDynamicStyleEntry"/> to evaluate and set style
    /// </summary>
    /// <param name="row">The row.</param>
    /// <param name="table">The table.</param>
    /// <param name="entry">The entry.</param>
    /// <returns></returns>
    public delegate dataTableStyleEntry rowMetaEvaluation(DataRow row, DataTable table, dataTableStyleEntry defaultStyle);
