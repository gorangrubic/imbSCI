        ...
        protected tableStyleSetterResponse makeDefaultResponse(Double evaluationValue, dataTableStyleEntry okStyle, dataTableStyleEntry noStype)
        {
            ...
            else if (evaluationValue > 0) 
            {
                if (colorGradientDictionary != null)
                {
                    ...
                    output.style.Background.Color = colorGradientDictionary.GetColor(evaluationValue).getColorFromHex();
                    output.style.BackgroundAlt.Color = colorGradientDictionary.GetColor(evaluationValue).getColorFromHex();
