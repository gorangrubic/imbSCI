// --------------------------------------------------------------------------------------------------------------------
// <copyright file="aceCriterieConfig.cs" company="imbVeles" >
//
...
namespace imbSCI.Core.attributes
{
    ...
    /// <summary>
    /// Criterion definition (general purpose, meant for use with <see cref="imbAttribute"/>
    /// </summary>
    public class aceCriterionConfig
    {
        public aceCriterionConfig(IComparable _min, IComparable _max, IComparable _even, rangeCriteriaEnum _mode)
        {
            min = _min;
