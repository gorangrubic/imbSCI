       ...
       //  _tableName
        ...
        public virtual void reCalculate(preCalculateTasks tasks=preCalculateTasks.all)
        {
            ...
            //    //Measures.Entropy()
                ...
                entropyFreq = GetRFreqArray().GetEntropy();
                varianceFreq = Accord.Statistics.Measures.Variance(valArray, true);
                standardDeviation = Accord.Statistics.Measures.StandardDeviation(valArray, avgFreq, true);
            //}
