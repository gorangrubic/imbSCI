// --------------------------------------------------------------------------------------------------------------------
// <copyright file="columnMetaEvaluation.cs" company="imbVeles" >
//
...
using System.Collections.Generic;
    ...
    public delegate tableStyleSetterResponse columnMetaEvaluation(DataRow row, DataColumn column, DataTable table,  dataTableStyleEntry defaultStyle);
